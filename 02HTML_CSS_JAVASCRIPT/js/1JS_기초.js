...
// document = html 문서, queryselector = tag 찾는 것. link에 a태그를 집어넣어라!
...
// 반복되는 요소에 이벤트 한꺼번에 연결하기
 ...
 const deg = 45; // 회전 각도 설정
 let num2 = 0; // 회전 각도의 초기 설정

 //btnLeft를 클릭할 때
 btnLeft.addEventListener("click",e=>{
    e.preventDefault();
    num2--;
    console.log(`num2:${num2}`) //백틱(`) 사용. 문자열과 변수에 있는 값을 꺼내서 출력을 동시에 할 때  
